#ifndef __MB_UTILS_M_H__
#define __MB_UTILS_M_H__
 ...
 * \endcode
 */
void            xMB_MASTER_UtilSetBits( UCHAR * ucByteBuf, USHORT usBitOffset,
 ...
 * \endcode
 */
UCHAR           xMB_MASTER_UtilGetBits( UCHAR * ucByteBuf, USHORT usBitOffset,
                                UCHAR ucNBits );
