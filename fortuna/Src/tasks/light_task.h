...
/*灯条任务信号*/
#define  LIGHT_TASK_LIGHT_PWR_ON_SIGNAL            (1<<0)
#define  LIGHT_TASK_LIGHT_PWR_OFF_SIGNAL           (1<<1)
#define  LIGHT_TASK_DEBUG_LIGHT_PWR_ON_SIGNAL      (1<<2)
#define  LIGHT_TASK_DEBUG_LIGHT_PWR_OFF_SIGNAL     (1<<3)
