...
/*无效的重量值*/
#define  SCLAE_NET_WEIGHT_DIS_INVALID_VALUE                 99999
#define  SCLAE_NET_WEIGHT_DIS_INVALID_VALUE_NEGATIVE       (-9999)
#define  SCLAE_NET_WEIGHT_DIS_INVALID_VALUE_ERR            0xffff
